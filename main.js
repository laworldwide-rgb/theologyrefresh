...
// ── PostHog ──────────────────────────────────────────────
const POSTHOG_KEY = 'phc_PpClGEAn67NSz4zUz826djb5F9NoxfkNqQAwq1lcBox'
let posthog = null
import('https://cdn.jsdelivr.net/npm/posthog-js/dist/module.js')
  .then(m => {
    posthog = m.default
    posthog.init(POSTHOG_KEY, { api_host: 'https://app.posthog.com', autocapture: false })
  })
  .catch(() => {})
...
// ── Vercel Analytics ─────────────────────────────────────
import('https://cdn.jsdelivr.net/npm/@vercel/analytics/dist/index.js')
  .then(m => m.inject?.())
  .catch(() => {})
